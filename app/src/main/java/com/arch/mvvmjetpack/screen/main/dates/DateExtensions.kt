...
fun Date.toString(format: String, locally: Locale? = Locale.ENGLISH): String =
    SimpleDateFormat(format, locally).format(this)
...
fun Date.isCurrentMonth(): Boolean {
    ...
    return calendar[Calendar.YEAR] == today[Calendar.YEAR] && calendar[Calendar.MONTH] == (today[Calendar.MONTH])
}
